"""
We utilized an architecture in Lima, E.M., Ribeiro, A.H., Paixão, G.M.M. et al. Deep neural network-estimated electrocardiographic age as a 
mortality predictor. Nat Commun 12, 5117 (2021). https://doi.org/10.1038/s41467-021-25351-7. 
Implemented in https://github.com/antonior92/ecg-age-prediction.
"""
...
class ResNet1d(nn.Module):
    ...
    def __init__(self, input_dim, blocks_dim, kernel_size=17, dropout_rate=0.8):
        ...
        self.lin = nn.Linear(last_layer_dim, 1)
